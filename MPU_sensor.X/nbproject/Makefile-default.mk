...
FINAL_IMAGE=${DISTDIR}/MPU_sensor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/MPU_sensor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq (3,1) 
	...
	@mv ${OBJECTDIR}/main.hex "${DISTDIR}/MPU_sensor.X.${IMAGE_TYPE}.hex"
else 
